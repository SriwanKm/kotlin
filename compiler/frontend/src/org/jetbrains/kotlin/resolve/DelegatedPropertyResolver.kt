...
class DelegatedPropertyResolver(
    ...
    private fun inferDelegateTypeFromGetSetValueMethods(
        ...
        resolutionResults.getOrNull(0)?.let { recordResolvedDelegateOrReportError(it.overloadResolutionResults, isGet = true) }
        resolutionResults.getOrNull(1)?.let { recordResolvedDelegateOrReportError(it.overloadResolutionResults, isGet = false) }
