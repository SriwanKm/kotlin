...
abstract class InlineCodegen<out T : BaseExpressionCodegen>(
    ...
    protected fun endCall(result: InlineResult, usedAsExpression: Boolean) {
        leaveTemps()
        ...
        codegen.markLineNumberAfterInlineIfNeeded(usedAsExpression)
    }
    ...
    fun performInline(
        ...
        try {
            ...
            endCall(inlineCall(nodeAndSmap, inlineDefaultLambdas), usedAsExpression)
